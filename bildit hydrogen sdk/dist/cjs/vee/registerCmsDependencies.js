...
function registerCmsDependencies() {
    if (typeof window === 'undefined')
        return;
    const cmsDependencies = {};
    for (const [key, config] of Object.entries(hydrogenDependencies.hydrogenDependenciesConfig)) {
        if (config.module) {
            cmsDependencies[key] = { module: config.module };
        }
    }
    window.cmsDependencies = cmsDependencies;
}

exports.registerCmsDependencies = registerCmsDependencies;
