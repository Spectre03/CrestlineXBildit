...
var ensureHostReactGlobals = require('./ensureHostReactGlobals.js');
...
function BilditAdminBridge({ adminScript = DEFAULT_ADMIN_SCRIPT, }) {
    React.useEffect(() => {
        ...
        const onMessage = (event) => {
            ...
            ensureHostReactGlobals.ensureHostReactGlobals();
...
exports.BilditAdminBridge = BilditAdminBridge;
exports.DEFAULT_ADMIN_SCRIPT = DEFAULT_ADMIN_SCRIPT;
