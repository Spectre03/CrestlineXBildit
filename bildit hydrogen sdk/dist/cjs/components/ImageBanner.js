...
const ImageBanner = ({ id, imgProps }) => {
    const imgContent = React.useMemo(() => {
        ...
        if (typeof image !== 'string')
            return null;
        if (reactCore.isLiteralNullishUrlString(image))
            return null;
        ...
        const content = (JsxRuntime.jsx("img", { src: image, alt: altText, width: hasDimensions ? preview === null || preview === void 0 ? void 0 : preview.w : undefined, height: hasDimensions ? preview === null || preview === void 0 ? void 0 : preview.h : undefined, style: hasDimensions ? undefined : STYLES.fillImage }));
        const hasLink = !!(url && url.length > EMPTY_LEN) && !reactCore.isLiteralNullishUrlString(url);
        const imageContent = (JsxRuntime.jsx("div", { style: {
                ...STYLES.imageWrapper,
                ...(imgProps.addBottomMargin ? STYLES.bottomMargin : undefined),
            }, children: hasLink ? (JsxRuntime.jsx("a", { "data-aali": adobeAnalytics, href: url, children: content })) : (content) }));
        return (JsxRuntime.jsx("div", { id: id, style: { display: 'contents' }, children: imageContent }));
    }, [id, imgProps]);
    return imgContent;
};
var ImageBanner$1 = React.memo(ImageBanner);

exports.default = ImageBanner$1;
